...
def snap(phone):
    ...
    try:
        ...
        if "OK" in snapR:
            print(f'{w}CopyRight Coded By {r}@NEXT_1Ne')
            return True
    except:
        pass
def gap(phone):
    ...
    try:
        ...
        if "OK" in gapR:
            print(f'{r}(Gap) {g}Request Was Sent')
            return True
    except:
        pass
def tap30(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if sfoodR['status'] == True:
            print(f'{r}(SnapFood) {g}Request Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if smarketR['status'] == True:
            print(f'{r}(SnapMarket) {g}Request Was Sent')
            return True
    except:
        pass
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if gaR['Code'] == 1:
            print(f'{r}(GapFilm) {g}Request Was Sent')
            return True
    except:
        pass
def sTrip(phone):
    sTripH = {"Host": "www.snapptrip.com","User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0","Accept": "*/*","Accept-Language": "fa","Accept-Encoding": "gzip, deflate, br","Content-Type": "application/json; charset=utf-8","lang": "fa","X-Requested-With": "XMLHttpRequest","Content-Leng
